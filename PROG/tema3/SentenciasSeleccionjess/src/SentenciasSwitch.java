...
public class SentenciasSwitch {
    ...
    public void usoSwitchInt() {
        ...
        switch (valor) {
            ...
            default://es como el else es optativo
                nombre = "sin nombre";
    ...
    public void usoSwitchString () {
            String nombres = "Borja";
            switch (nombres.toLowerCase()) {//funcion que pasa a minusculas para q pueda pasarlo x los casos
                case "borja":
    ...
    public void usoSwitchLambda() {
        int nota = 7;
        switch (nota) {
            case 1 -> {//los bloques estam separados por llaves se puede poner variables en cada uno
                System.out.println("Seleccionado el caso 1");
            }// no se necesita break porq tiene llave de cierre
            case 2 -> {
    ...
    public void menuOpciones() {
        ...
        switch (opcion) {
            ...
            case 4 -> {
                ...
                if (op2 == 0) {
                    System.out.println("Resultado incierto, se aplica la regla de 0");//un operando es 0 es redundante no hace falta ponerlo xk ya esta inicializado en 0
                    // resultado = 0;
                } else {
                    resultado = (double) op1 / op2;//casteo para que el resultado sea double
                }
            }
            case 5 -> {
